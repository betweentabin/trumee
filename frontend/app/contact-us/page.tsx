              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-6">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full md:w-auto px-8 py-3 rounded-lg bg-[#FF733E] text-white font-semibold shadow-md hover:bg-[#FF8659] focus:outline-none focus:ring-2 focus:ring-[#FF733E] disabled:bg-gray-300 disabled:text-gray-600 flex items-center justify-center gap-2"
                  >
                    <FaPaperPlane />
                    {loading ? '送信中...' : '送信する'}
                  </button>
